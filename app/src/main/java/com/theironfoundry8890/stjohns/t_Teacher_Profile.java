...
public class t_Teacher_Profile extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(appFirstUse)
        {
            ...
            Intent selectIntent = new Intent(t_Teacher_Profile.this,signin.class);
    ...
    public void onClickintro(View v) {
        ...
        Intent selectIntent = new Intent(t_Teacher_Profile.this, s_EditProfileActivity.class);
        startActivity(selectIntent);
    ...
    public void onClickAttendance(View v) {
        Intent selectIntent = new Intent(t_Teacher_Profile.this, feedbackWriter.class);
        startActivity(selectIntent);
